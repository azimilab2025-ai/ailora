...
Decision: `CONDITIONAL_LOCAL_PROTOTYPE_PASS_PRODUCTION_BLOCKED`
...
The machine-readable source of this statement is `docs/qualification/final-release-manifest.json`. It binds every pre-C20 checkpoint and qualification document to a SHA-256 digest. A passing local gate proves only the stated local prototype contract.
