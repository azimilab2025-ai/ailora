...
- `DOMAIN_REVIEW_REQUIRED` remains open.
- `LEGAL_REVIEW_REQUIRED` remains open.
- `LIVE_NASA_DATA=NOT_ACTIVATED`.
- `OYA_STATUS=DISABLED`.
- `HUMAN_RELEASE_AUTHORITY=MANDATORY`.
- No deployment, production, provider, credential, paid, operational-command, NASA, or Oya action occurred.
